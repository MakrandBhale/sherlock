...
export function viewFactory_ContactPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ContactPage> {
  if ((renderType_ContactPage === (null as any))) { (renderType_ContactPage = viewUtils.createRenderComponentType('C:/Users/Makrand/Desktop/sherlock/sherlock/.tmp/pages/contact/contact.html',0,import9.ViewEncapsulation.None,styles_ContactPage,{})); }
